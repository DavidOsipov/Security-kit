...
test("createSecurePostMessageListener: allowOpaqueOrigin opt-in and default reject behavior", () => {
  ...
  const listenerA = createSecurePostMessageListener({
    allowedOrigins: [],
    onMessage: (d, ctx) => {
      receivedA = { d, ctx };
    },
  ...
  const listenerB = createSecurePostMessageListener({
    allowedOrigins: [],
    onMessage: (d, ctx) => {
      receivedB = { d, ctx };
    },
  ...
  const listenerC = createSecurePostMessageListener({
    allowedOrigins: [],
    onMessage: (d, ctx) => {
      receivedC = { d, ctx };
    },
  ...
  const listenerD = createSecurePostMessageListener({
    allowedOrigins: [],
    onMessage: (d, ctx) => {
      receivedD = { d, ctx };
    },
